                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($assignment->checkpoint->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($assignment->checkpoint->client->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($assignment->checkpoint->branch->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($assignment->date_from ? \Carbon\Carbon::parse($assignment->date_from)->format('M d, Y') : 'N/A'); ?></td>
                                    <td><?php echo e($assignment->date_to ? \Carbon\Carbon::parse($assignment->date_to)->format('M d, Y') : 'N/A'); ?></td>
                                    <td><?php echo e($assignment->notes ?? 'N/A'); ?></td>
                                    <td>
                                        <div class="d-flex gap-1">
                                            <button class="btn btn-warning btn-sm edit-assignment-btn"
                                                    ...
                                                    data-client-id="<?php echo e(optional(optional($assignment->checkpoint)->client)->id); ?>"
                                                    data-branch-id="<?php echo e(optional(optional($assignment->checkpoint)->branch)->id); ?>"
                                                    data-date-from="<?php echo e($assignment->date_from); ?>"
                                                    data-date-to="<?php echo e($assignment->date_to); ?>"
