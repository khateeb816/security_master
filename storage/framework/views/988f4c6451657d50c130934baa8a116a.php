...
<head>
    ...
    #guardMap { height: 400px; border-radius: 12px; overflow: hidden; }
...
<div class="dropdown">
    <a class="position-relative" href="#" id="notifDropdown" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <ul class="dropdown-menu dropdown-menu-end shadow-sm p-2" aria-labelledby="notifDropdown" style="min-width: 300px;">
        ...
        <li><hr class="dropdown-divider"></li>
        <li>
            <a href="#" class="dropdown-item text-center text-primary small">View All Notifications</a>
        </li>
    </ul>
</div>
...
<?php /**PATH C:\Users\Bilawal\CascadeProjects\remote_project\resources\views/layouts/app.blade.php ENDPATH**/ ?>