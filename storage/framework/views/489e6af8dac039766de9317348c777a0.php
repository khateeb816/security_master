                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary"
                                    ...
                                    data-cnic="<?php echo e($user->cnic); ?>"
                                    data-nfc-uid="<?php echo e($user->nfc_uid); ?>"
                                    data-designation="<?php echo e($user->designation); ?>"
                                    data-role="<?php echo e($user->role); ?>"
                                    data-status="<?php echo e($user->status); ?>"
                                    data-client-id="<?php echo e($user->client_id); ?>"
                                    data-branch-id="<?php echo e($user->branch_id); ?>"
                                    data-latitude="<?php echo e($user->latitude); ?>"
                                    data-longitude="<?php echo e($user->longitude); ?>">
                                    <i class="fas fa-edit"></i> Edit
                                </button>

                                <form action="<?php echo e(route('users.destroy', $user->id)); ?>" method="POST" class="d-inline" onsubmit="return deleteUser(event, this)">
                                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content border-0 shadow rounded-4">
            ...
            <form method="POST" action="<?php echo e(route('users.store')); ?>" id="userForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bilawal\CascadeProjects\remote_project\resources\views/users.blade.php ENDPATH**/ ?>