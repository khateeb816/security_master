                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1" role="group">
                                    <a href="{{ route('guards.show', $guard->id) }}" class="btn btn-primary btn-sm" title="View Details">
                                    ...
                                    <button class="btn btn-info assign-checkpoint-btn" data-guard-id="{{ $guard->id }}" data-guard-name="{{ $guard->name }}" data-bs-toggle="modal" data-bs-target="#assignCheckpointModal" title="Assign Checkpoint">
