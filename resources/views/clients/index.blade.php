                            ...
                            <td>
                                <div class="d-flex gap-1" role="group">
                                    <button class="btn btn-warning edit-client-btn" 
                                            ...
                                            data-arc-id="{{ $client->arc_id }}"
                                            data-incident-report-email="{{ $client->incident_report_email ? '1' : '0' }}"
                                            data-mobile-form-email="{{ $client->mobile_form_email ? '1' : '0' }}"
                                            data-additional-recipients="{{ $client->additional_recipients }}"
    ...
    <div class="modal-dialog modal-lg">
        <form id="editClientForm" class="modal-content" method="POST">
            ...
            <div class="modal-body row g-3">
                ...
                <div class="col-md-6">
                    <label class="form-label">ARC Client ID</label>
                    <input type="text" id="edit_arc_id" name="arc_id" class="form-control" value="{{ old('arc_id') }}">
                </div>
                <div class="col-md-6">
                    <div class="form-check mt-4">
        ...
        try {
            ...
            try {
                ...
                // If successful but no redirect, go to clients index
                    ...
                    window.location.href = '{{ route('clients.index') }}?success=' + encodeURIComponent(data.message || 'Operation completed successfully');
                    return;
                }
            } catch (e) {
