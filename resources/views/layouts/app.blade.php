...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('clients.index') }}" class="{{ request()->routeIs('clients.index') ? 'active' : '' }}"><i
                class="fas fa-building me-2"></i> Add Clients</a>
        <a href="{{ route('guards.index') }}" class="{{ request()->routeIs('guards.index') ? 'active' : '' }}"><i
        ...
        @endphp
        <a href="{{ $checkpointUrl }}"
            class="{{ request()->routeIs('clients.branches.checkpoints.*') ? 'active' : '' }}"
        ...
        @endpush
        <a href="{{ route('patrol.logs') }}" class="{{ request()->routeIs('patrol.logs') ? 'active' : '' }}"><i
                class="fas fa-route me-2"></i> Patrol Logs</a>
        <a href="{{ route('incidents') }}" class="{{ request()->routeIs('incidents') ? 'active' : '' }}"><i
