...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <!-- Branch Filter -->
            <div class="position-relative" style="min-width: 220px;">
                <select name="branch_id" id="branchFilter" class="form-select form-select-lg border-2 border-info" style="height: 38px; border-radius: 8px;" {{ !request('client_id') ? 'disabled' : '' }}>
            ...
            <button class="btn btn-primary d-flex align-items-center gap-2" id="addCheckpointBtn" {{ !request('branch_id') ? 'disabled' : '' }} style="height: 38px; border-radius: 8px;">
                                ...
                                <tr data-id="{{ $checkpoint->id }}">
                                    ...
                                    <td class="text-nowrap">
                                        <div class="d-flex gap-1">
                                            <button class="btn btn-sm btn-outline-primary edit-checkpoint d-flex align-items-center gap-1" data-id="{{ $checkpoint->id }}" title="Edit">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="branch_id" name="branch_id" required>
                            ...
                            @if(isset($branches) && $branches->count() > 0)
                                @foreach($branches as $branch)
                                    <option value="{{ $branch->id }}" data-lat="{{ $branch->latitude }}" data-lng="{{ $branch->longitude }}" {{ request('branch_id') == $branch->id ? 'selected' : '' }}>
                                        {{ $branch->branch_name }}
                                    </option>
                                @endforeach
                            @endif
